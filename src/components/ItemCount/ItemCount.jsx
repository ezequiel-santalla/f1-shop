...
const ItemCount = ({ initial, stock, functionAdd, logo }) => {
    ...
    <>
      <div className="col-span-4 bg-gray-100">
        <div className="grid grid-cols-12 grid-rows-4 m-2 p-3">
          ...
          <p className="col-span-11 ps-3">{letter}</p>
          <button
          ...
          <button onClick={() => functionAdd(counter)} className={`bg-black grid grid-cols-12 col-span-9 self-center justify-items-end text-white rounded-md py-2`}>
